            ...
            var startRecording = function () {
                ...
                if (!options.saveToGallery) {
                    ...
                    if (sdkVersionInt > 21) {
                        ...
                        file = new java.io.File(path);
                        tempPictureUri = android.support.v4.content.FileProvider.getUriForFile(applicationModule.android.currentContext, applicationModule.android.nativeApp.getPackageName() + ".provider", file);
